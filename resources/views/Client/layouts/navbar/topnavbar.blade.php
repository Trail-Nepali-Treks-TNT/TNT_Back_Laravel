    ...
    <div class="container-fluid tnt-container d-flex flex-wrap align-items-sm-center">
        <a href="/" class="d-flex align-items-center me-auto text-decoration-none text-white top-nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                class="lucide lucide-ticket size-4">
                <path
        ...
        <ul class="nav d-flex align-items-center">
            <li class="nav-item">
                <a href="https://wa.me/1234567890" target="_blank" class="nav-link text-white px-2 top-nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="whatsapp-icon" viewBox=" 0 0 48 48">
                        <path fill="#fff"

        ...
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active">
                    <a href="javascript:void(0)">Accomodation</a>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="row">
                <div class="widget-content searchable-container list">
                    <div class="d-flex justify-content-end mb-3 mt-3">
                        <a href="{{ route('Accomodation.create') }}" style="margin-right: 17px;"> <button class="btn btn-primary">Add New</button></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card card-body">
            <div class="table-responsive">
                ...
                <table class="table table-bordered search-table v-middle">
                    ...
                    <tbody>
                        @foreach ($accomodation as $index => $level)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $level->name }}</td>
                            <td>{{ $level->description }}</td>
                            <td>
                                <a href="{{ route('Accomodation.edit', $level->id) }}"
                                ...
                                <a href="{{ route('Accomodation.delete', $level->id) }}"

            ...
            <div class="row">
                <div class="widget-content searchable-container list">
                    <div class="d-flex justify-content-end mb-3 mt-3">
                        <a href="{{ route('Category.create') }}" style="margin-right: 17px;"> <button class="btn btn-primary">Add New</button></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card card-body">
            <div class="table-responsive">
                ...
                <table class="table table-bordered search-table v-middle">
                    ...
                    <tbody>
                        @foreach ($category as $index => $level)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $level->name }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('Category.delete', $level->id) }}"
